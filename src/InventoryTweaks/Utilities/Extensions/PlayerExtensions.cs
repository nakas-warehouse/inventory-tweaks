...
public static class PlayerExtensions
{
    ...
    ///     When this method returns <see langword="true" />, contains the inventory items of the opened
    ///     chest.
    ///     When this method returns <see langword="false" />, contains <c>null</c>.
    /// </param>
    /// <returns>
    ///     <see langword="true" /> if the player has an open chest and the inventory was retrieved
    ///     successfully;
    ...
    /// </param>
    /// <returns>
    ///     <see langword="true" /> if the player has an open piggy bank and the inventory was retrieved
    ///     successfully;
    ///     otherwise, <see langword="false" />.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    ///     <see langword="true" /> if the player has an open safe and the inventory was retrieved
    ///     successfully;
    ///     otherwise, <see langword="false" />.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    ///     <see langword="true" /> if the player has an open void vault and the inventory was retrieved
    ///     successfully;
    ///     otherwise, <see langword="false" />.
    /// </returns>
    ...
    /// </param>
    /// <returns>
    ///     <see langword="true" /> if the player is accessing any supported container and the inventory
    ///     was
